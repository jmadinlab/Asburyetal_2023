...
# create raster for islands age 
require(rgdal)

test <- raster("data/hi_opt_all_wave_anom_max.tif")

#https://pubs.usgs.gov/pp/1987/1350/pdf/chapters/pp1350_ch1.pdf
kilauea <- readOGR(dsn = "data/hi_opt_all_wave_anom_max.tif", layer = "Kilauea")
kilauea.r <- mask(test, kilauea)
#plot(kilauea.r)
kilauea.r[kilauea.r@data@values > 0.0000000001] <- 0.2 #mya
plot(kilauea.r)

#https://www.researchgate.net/publication/249526517_Volcano_growth_and_evolution_of_the_island_of_Hawaii
hualalai <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "Hualalai")
hualalai.r <- mask(test, hualalai)
#plot(hualalai.r)
hualalai.r[hualalai.r@data@values > 0.0000000001] <- 0.3 #mya
#plot(hualalai.r)

#https://pubs.usgs.gov/pp/1987/1350/pdf/chapters/pp1350_ch1.pdf
maunakae <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "MaunaKea")
maunakae.r <- mask(test, maunakae)
#plot(maunakae.r)
maunakae.r[maunakae.r@data@values > 0.0000000001] <- 0.375 #mya
#plot(maunakae.r)

#https://pubs.usgs.gov/pp/1987/1350/pdf/chapters/pp1350_ch1.pdf
kohala <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "Kohala")
kohala.r <- mask(test, kohala)
#plot(kohala.r)
kohala.r[kohala.r@data@values > 0.0000000001] <- 0.43 #mya
#plot(kohala.r)

#https://www.researchgate.net/publication/249526517_Volcano_growth_and_evolution_of_the_island_of_Hawaii
maunaloa <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "MaunaLoa")
maunaloa.r <- mask(test, maunaloa)
#plot(maunaloa.r)
maunaloa.r[maunaloa.r@data@values > 0.0000000001] <- 0.3 #mya
#plot(maunaloa.r)

#all the rest: https://pubs.usgs.gov/pp/1987/1350/pdf/chapters/pp1350_ch1.pdf
haleakala <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "Haleakala")
haleakala.r <- mask(test, haleakala)
#plot(haleakala.r)
haleakala.r[haleakala.r@data@values > 0.0000000001] <- 0.75 #mya
#plot(haleakala.r)

kahoolawe <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "Kahoolawe")
kahoolawe.r <- mask(test, kahoolawe)
#plot(kahoolawe.r)
kahoolawe.r[kahoolawe.r@data@values > 0.0000000001] <- 1.03 #mya
#plot(kahoolawe.r)

westmaui <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "WestMaui")
westmaui.r <- mask(test, westmaui)
#plot(westmaui.r)
westmaui.r[westmaui.r@data@values > 0.0000000001] <- 1.32 #mya
#plot(westmaui.r)

lanai <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "Lanai")
lanai.r <- mask(test, lanai)
#plot(lanai.r)
lanai.r[lanai.r@data@values > 0.0000000001] <- 1.28 #mya
#plot(lanai.r)

eastmolokai <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "EastMolokai")
eastmolokai.r <- mask(test, eastmolokai)
#plot(eastmolokai.r)
eastmolokai.r[eastmolokai.r@data@values > 0.0000000001] <- 1.76 #mya
#plot(eastmolokai.r)

westmolokai <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "WestMolokai")
westmolokai.r <- mask(test, westmolokai)
#plot(westmolokai.r)
westmolokai.r[westmolokai.r@data@values > 0.0000000001] <- 1.90 #mya
#plot(westmolokai.r)

koolau <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "Koolau")
koolau.r <- mask(test, koolau)
#plot(koolau.r)
koolau.r[koolau.r@data@values > 0.0000000001] <- 2.6 #mya
#plot(koolau.r)

waianae <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "Waianae")
waianae.r <- mask(test, waianae)
#plot(waianae.r)
waianae.r[waianae.r@data@values > 0.0000000001] <- 3.7 #mya
#plot(waianae.r)

kauai <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "Kauai")
kauai.r <- mask(test, kauai)
#plot(kauai.r)
kauai.r[kauai.r@data@values > 0.0000000001] <- 5.1 #mya
#plot(kauai.r)

niihau <- readOGR(dsn = "C:/Users/Mollie.Asbury/Desktop/NOAA_surface_geometry/habitat/IslandAge", layer = "Niihau")
niihau.r <- mask(test, niihau)
#plot(niihau.r)
niihau.r[niihau.r@data@values > 0.0000000001] <- 4.89 #mya
#plot(niihau.r)


x <- list(kilauea.r, kohala.r, hualalai.r, maunakae.r, maunaloa.r, haleakala.r, kahoolawe.r, westmaui.r, lanai.r, eastmolokai.r, 
          westmolokai.r, koolau.r, waianae.r, kauai.r, niihau.r)
age <- do.call(merge, x)
plot(age)

age@data@names <- "age"

writeRaster(age, "habitat/IslandAge.tif")
